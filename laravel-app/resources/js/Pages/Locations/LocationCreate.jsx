...
export default function LocationCreate() {
    ...
    return (
        <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Crear Nueva Ubicación</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex space-x-4 pt-4">
                    <Link
                        href="/locations"
                        className="flex-1 text-center bg-gray-200 hover:bg-gray-300 text-gray-800 py-2 px-4 rounded-md transition-colors"
                    >
                        Volver
                    </Link>
                    <button
